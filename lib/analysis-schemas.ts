...
export const FactExtractionSchema = z.object({
  ...
  funder_requirements: z.array(
    z.object({
      requirement: z.string(),
      governing_quote: z.string(),
...
export const FunderResearchSchema = z.object({
  ...
  profile: z.object({
    mission: z.string(),
    current_program_areas: z.array(z.string()),
    geographic_focus: z.array(z.string()),
    typical_award_size: z.string(),
    grant_duration: z.string(),
    organization_types: z.array(z.string()),
    selection_principles: z.array(z.string()),
    exclusions: z.array(z.string()),
    application_process: z.string(),
  }),
  comparable_grants: z.array(
    z.object({
      grantee: z.string(),
      amount: z.string(),
      year: z.string(),
  ...
  opportunity_cost: z.object({
    complexity: z.string(),
    staff_effort: z.string(),
    relationship_dependency: z.string(),
    revision_burden: z.string(),
  }),
  sources: z.array(
    z.object({
      title: z.string(),
      ...
      url: z.string(),
      reliability_tier: z.number().int().min(1).max(7),
      notes: z.string(),
    }),
  ),
  confidence,
...
const ClaimSchema = z.object({
  ...
  contradicting_sources: z.array(z.string()),
  source_quality: z.enum(["high", "medium", "low", "none"]),
  confidence,
  issue: z.string(),
  required_fix: z.string(),
  fix_category: fixCategory,
...
export const DueDiligenceSchema = z.object({
  ...
  evidence_coverage: z.object({
    ...
    unverifiable_claims: z.number().int(),
...
export const ReviewerPanelSchema = z.object({
  ...
  rejection_memo: z.object({
    ...
    strongest_rejection_reasons: z.array(z.string()),
    evidence_for_rejection: z.array(z.string()),
    evidence_that_could_change_recommendation: z.array(z.string()),
  ...
  failure_premortem: z.array(
    z.object({
      cause: z.string(),
      earliest_warning_sign: z.string(),
      preventive_action: z.string(),
      owner: z.string(),
      monitoring_indicator: z.string(),
    }),
  ),
});
...
export const AdjudicationSchema = z.object({
  ...
  proposal_merit: z.enum([
    "deserves_to_win",
    "competitive_with_fixable_weaknesses",
    "borderline",
    "does_not_yet_deserve_funding",
    "do_not_submit_to_this_funder",
  ]),
  ...
  revision_priorities: z.array(
    z.object({
      rank: z.number().int(),
      title: z.string(),
      decision_impact: z.enum(["very_high", "high", "medium", "low"]),
      severity,
      effort: z.enum(["low", "medium", "high"]),
      feasible_before_deadline: z.enum(["yes", "no", "unclear"]),
      required_fix: z.string(),
      fix_category: fixCategory,
  ...
  citation_audit: z.object({
    passed: z.boolean(),
    unsupported_final_claims: z.array(z.string()),
    weak_sources: z.array(z.string()),
...
export type FunderResearch = z.infer<typeof FunderResearchSchema>;
